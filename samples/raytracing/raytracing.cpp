...
public:
	...
	static Skybox* Create()
	{
		...
		stbi_uc* pixels[6];
		pixels[0] = stbi_load("raytracing/skybox/Front+Z.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
		pixels[1] = stbi_load("raytracing/skybox/Back-Z.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
		pixels[2] = stbi_load("raytracing/skybox/Up+Y.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
		pixels[3] = stbi_load("raytracing/skybox/Down-Y.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
		pixels[5] = stbi_load("raytracing/skybox/Left+X.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
		pixels[4] = stbi_load("raytracing/skybox/Right-X.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
		...
		vertShaderDesc.codes = StringUtils::ReadFile("raytracing/skybox.vert");
		...
		fragShaderDesc.codes = StringUtils::ReadFile("raytracing/skybox.frag");
...
GFX::Pipeline CreateMeshPipeline()
{
	...
	vertDesc.codes = StringUtils::ReadFile("raytracing/default.vert");
	...
	fragDesc.codes = StringUtils::ReadFile("raytracing/default.frag");
...
void RaytracingExample::Init()
{
	...
	s_scene = 
		// LoadScene("raytracing/carved_pillar.fbx");
		LoadScene("raytracing/TEST2.fbx");
	
	// CreateModelUniformBlock("raytracing/carved_pillar_Albedo.jpg");
	CreateModelUniformBlock("raytracing/texture.jpg");
...
void RaytracingExample::CleanUp()
{
	delete skybox;
